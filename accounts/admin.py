...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ('user_name','belongto','is_active','expire_date','real_name','sex','phone_number','email','Role')
    list_filter = ('admin','is_active')
    
    fieldsets = (
        (None, {'fields': ('user_name','password','belongto','is_active','expire_date','real_name','sex','phone_number','email','Role')}),
