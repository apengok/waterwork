(function(window,$){
    ...
    concentratorManagement = {
        init: function(){
            ...
            var setting = {
                suffix  : '/',
                listUrl : '/devm/concentrator/list/',
...
//            zTree.cancelSelectedNode();
        ...
        groupListTree : function(){
            var treeSetting = {
                async : {
                    ...
                    dataFilter: concentratorManagement.groupAjaxDataFilter
                },
                view : {
                    selectedMulti : false,
                    nameIsHTML: true,
                ...
                callback : {
                    onClick : concentratorManagement.zTreeOnClick
                }
            };
    ...
    $(function(){
        $('input').inputClear();
        concentratorManagement.init();
        concentratorManagement.groupListTree();
        ...
        //全选
        $("#checkAll").bind("click",concentratorManagement.cleckAll);
        //单选
        subChk.bind("click",concentratorManagement.subChkClick);
        //批量删除
        $("#del_model").bind("click",concentratorManagement.delModel);
        //加载完成后执行
        $("#refreshTable").on("click",concentratorManagement.refreshTable);
        // 组织架构模糊搜索
