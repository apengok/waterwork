...
if ($(".tooltip-demo").tooltip({
        ...
        i.slideToggle(200), e.toggleClass("fa-chevron-up").toggleClass("fa-angle-down"),e.toggleClass("fa-angle-up").toggleClass("fa-chevron-down"), o.toggleClass("").toggleClass("border-bottom"), setTimeout(function() {
